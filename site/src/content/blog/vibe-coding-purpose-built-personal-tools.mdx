...
LLMs thrive in small problem spaces. Huge codebases or ambiguious, broad goals for the final product often lead to a frustrating experience working against hallucinations, the agent fixes one bug only to create two more.
