...
> [!NOTE] Vibe Coding
> The use of artificial intelligence prompted by natural language to assist with the writing of computer code. - Collins Dictionary
...
> Summarised by [Peter H. Salus](https://en.wikipedia.org/wiki/Peter_H._Salus), the philosophy can be broken down into 3 points.
