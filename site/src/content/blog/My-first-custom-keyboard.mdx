...
<figure>
  <Image src={partsImage} alt="Keyboard parts laid out: switches, microcontroller, TRRS cable" />
...
<figure>
  <Image src={partialImage} alt="Keyboard parts laid out: switches, microcontroller, TRRS cable" />
  <figcaption>Partially assembled - only switches soldered.</figcaption>
</figure>
