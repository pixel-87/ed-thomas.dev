...
This was a bit more ambitious than my last hardware project, making a second monitor from a laptop screen, so maybe the next project can be another step up.
